...
def merge_data(array1, array2)
  new_hash_1 = {array1[0].keys.to_a[0] => array1[0].values.to_a[0]}
  new_hash_2 = {array1[1].keys.to_a[0] => array1[1].values.to_a[0]}
  new_hash_1 = new_hash_1.merge(array2[0].values.to_a[0])
  new_hash_2 = new_hash_2.merge(array2[1].values.to_a[0])
  new_hash_1[array1[0].keys.to_a[1]] = array1[0].values.to_a[1]
  new_hash_2[array1[1].keys.to_a[1]] = array1[1].values.to_a[1]
