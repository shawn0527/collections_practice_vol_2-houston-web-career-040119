...
def merge_data(array1, array2)
  ...
  new_hash_1 = new_hash_1.merge(array2[0].values[0].to_a[0])
  new_hash_2 = new_hash_2.merge(array2[1].values[0].to_a[1])
...
def merge_data(array1, array2)
  new_hash_1 = array1[0].merge(array2[0].values.to_a[0][0])
  new_hash_2 = array1[1].merge(array2[1].values.to_a[0][0])
  [new_hash_1, new_hash_2]
end
